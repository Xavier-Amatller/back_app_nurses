 ...
 */
final class Version20250408145726 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dietas (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE registros (id INT AUTO_INCREMENT NOT NULL, aux_id INT NOT NULL, pac_id INT NOT NULL, cv_id INT DEFAULT NULL, die_id INT DEFAULT NULL, reg_timestamp DATETIME DEFAULT NULL, INDEX IDX_E78E3BDF74D386B2 (aux_id), INDEX IDX_E78E3BDFAE21B650 (pac_id), UNIQUE INDEX UNIQ_E78E3BDFCFE419E2 (cv_id), UNIQUE INDEX UNIQ_E78E3BDF237DE2C0 (die_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
