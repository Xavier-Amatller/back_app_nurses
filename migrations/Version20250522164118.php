 ...
 */
final class Version20250522164118 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auxiliares (id INT AUTO_INCREMENT NOT NULL, aux_num_trabajador VARCHAR(10) NOT NULL, aux_nombre VARCHAR(50) NOT NULL, aux_apellidos VARCHAR(150) NOT NULL, aux_password VARCHAR(255) NOT NULL, roles JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', UNIQUE INDEX UNIQ_E87D4B909545DD69 (aux_num_trabajador), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE habitaciones (id INT AUTO_INCREMENT NOT NULL, pac_id INT DEFAULT NULL, hab_id VARCHAR(5) NOT NULL, hab_obs VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_E10783BF91851C3 (hab_id), UNIQUE INDEX UNIQ_E10783BAE21B650 (pac_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
